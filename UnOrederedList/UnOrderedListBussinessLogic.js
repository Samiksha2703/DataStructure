...
class UnOrderedListBussinessLogic {

    //method to read file    
    read() {
        let readData = fs.readFileSync('./UnOrderedReadFile.txt');
    ...
    write() {
        let value = "";
        let Data = fs.readFileSync('./UnOrderedReadFile.txt');
        ...
        let writeOutput = fs.writeFileSync('./UnOrderedReadFile.txt', output);
        console.log("File written successfully");
        console.log("The file contents :");
        console.log(output);
    }
}
module.exports = UnOrderedListBussinessLogic;